...
refugeedata<-read.csv('/lebanon/data/refugee.databb.csv')
...
lebmap <- readOGR(dsn = "/lebanon/data/LBN_adm-2/", "LBN_adm2")
...
lebmap <- readOGR(dsn = "/lebanon/data/LBN_adm-2/", "LBN_adm2",verbose = FALSE)
...
sectdata<-read.csv('/lebanon/data/lebsect.csv')
